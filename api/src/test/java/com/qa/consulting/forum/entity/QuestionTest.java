...
public class QuestionTest {
    ...
    public void setup() {
        ...
        question = new Question("Question Title", "Question Body", savedUser);
    }

    @Test
    public void testGetUserViewDTO() {
        UserViewDTO userViewDTO = question.getUserViewDTO();
    ...
    public void testGetNumberOfAnswers() {
        Assert.assertEquals(0, question.getNumberOfAnswers());
    }
}
